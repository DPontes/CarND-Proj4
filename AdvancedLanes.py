...
class Lane_Measure():
    ...
    ### Returns the points of the original data
...
### Belief is my instant vision of the world
...
class World:
    ...
    def sanity_check(self, left, right, p_left, p_right, p_m):
        ...
        # First check that lane width is reasonable
...
def process_an_image(world, folder, name, log_folder='./'):
...
def process_video(world, filename, first=1, last=1000000, log_folder=None, output_video=None):
    ...
    while ret and frame <= last:
        ...
        # This is just in case the first frame is very bad and has been rejected
...
video_pathname = './project_video.mp4'

process_video(world, video_pathname, first=1, output_video="./challenge_video_out.avi")
#process_an_image(world, "./test_images/", "test2.jpg")
